...
var Dolphin = require('./message.js');
...
router.route('/messages')
    ...
    .post(function(req, res) {
        ...
        dolphin.courseCode = req.body.courseCode; // set the dolphins name (comes from the request)
        dolphin.content = req.body.content;
        dolphin.timeStamp = req.body.timeStamp;
